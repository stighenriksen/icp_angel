...
var image5 = new Array()
    for ( var i = 0; i < texSize; i++ )  image5[i] = new Array();
    for ( var i = 0; i < texSize; i++ ) for ( var j = 0; j < texSize; j++ ) image5[i][j] = new Float32Array(4);
...
var image2 = new Uint8Array(image1);
    ...
    for ( var i = 0; i < texSize; i++ ) 
        for ( var j = 0; j < texSize; j++ ) 
           for(var k =0; k<4; k++) 
                image2[4*texSize*i+4*j+k] = 255*image5[i][j][k];
...
function init() {
    ...
    //
    var program = initShaders( gl, "shaders/vshader71.glsl", "shaders/fshader71.glsl" );
