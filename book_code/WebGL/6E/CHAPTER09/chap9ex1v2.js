...
function init() {
    ...
    //
    program = initShaders( gl, "shaders/vshader91.glsl", "shaders/fshader91.glsl" );
    ...
    b1.addEventListener("click", function(){doubleNumParticles(); update();}, false);
    
    var b2 = document.getElementById("Button2")
    b2.addEventListener("click", function(){numParticles /= 2; update();}, false);
    
    var b3 = document.getElementById("Button3")
    b3.addEventListener("click", function(){speed *=2;update();}, false);
    
    var b4 = document.getElementById("Button4")
    b4.addEventListener("click", function(){speed /= 2; update();}, false);
    
    var b5 = document.getElementById("Button5")
    b5.addEventListener("click", function(){pointSize *= 2;gl.uniform1f(gl.getUniformLocation(program, "PointSize"), pointSize); update();}, false);
    
    var b6 = document.getElementById("Button6")
    b6.addEventListener("click", function(){pointSize /= 2;gl.uniform1f(gl.getUniformLocation(program, "PointSize"), pointSize); update();}, false);
    
    var b7 = document.getElementById("Button7")
    b7.addEventListener("click", function(){gravity = !gravity; update()}, false);
    
    var b8 = document.getElementById("Button8")
    b8.addEventListener("click", function(){elastic = !elastic; update()}, false);
    
    var b9 = document.getElementById("Button9")
    b9.addEventListener("click", function(){repulsion = !repulsion; update()}, false);
...
forces = function(  ParticleI,  ParticleJ )
{
    var ParticleK;
    var force = 0.0;
